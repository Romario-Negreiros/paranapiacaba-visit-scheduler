...
export function VisitorForm({ selectedDate, onSubmit, onBack }: VisitorFormProps) {
  ...
  const handleSubmit = () => {
    if (validateForm()) {
      ...
      const duplicateCPF = existingBookings.find((booking: any) => 
        booking.cpf === formData.cpf.replace(/\D/g, '')
      );
  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
        ...
        <CardContent className="space-y-8">
          ...
          <div className="flex gap-4 pt-6">
            ...
            <Button
              ...
              size="lg"
              className="flex-1 h-16 text-lg bg-primary hover:bg-primary-hover"
            >
      ...
      <VirtualKeyboard
        ...
        type={activeField === 'cpf' ? 'numeric' : 'text'}
